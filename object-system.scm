;; Uppdaterad 2010-02-18 för nya standarden r6rs
;; Nytt namn på make-object till create-object. / AH
...
;; create-object creates an object of the argument type.
...
;  (let ((parent (create-object 'example-child)))
;    
